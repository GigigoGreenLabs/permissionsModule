...
package android.support.v4ox.internal.view;
...
public interface SupportMenuItem extends android.view.MenuItem {
    ...
    */
     ...
     * provider set via {@link #setSupportActionProvider(android.support.v4ox.view.ActionProvider)}. </p>
     *
    ...
    /**
     * Sets the {@link android.support.v4ox.view.ActionProvider} responsible for creating an action view if
     ...
     * @return This Item so additional setters can be called.
     * @see android.support.v4ox.view.ActionProvider
     */
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(android.support.v4ox.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link android.support.v4ox.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionExpand(MenuItem)} method
     ...
     * listener has been set using {@link #setSupportOnActionExpandListener(android.support.v4ox.view.MenuItemCompat.OnActionExpandListener)}
     * it will have its {@link android.support.v4ox.view.MenuItemCompat.OnActionExpandListener#onMenuItemActionCollapse(MenuItem)} method
     ...
     * @see android.support.v4ox.view.MenuItemCompat.OnActionExpandListener
     */
    public boolean isActionViewExpanded();

    /**
     * Set an {@link android.support.v4ox.view.MenuItemCompat.OnActionExpandListener} on this menu item to be notified when the associated
