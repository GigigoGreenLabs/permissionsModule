...
public class ActivityCompat extends ContextCompat {
     ...
     * android.support.v4ox.app.ActivityCompat.OnRequestPermissionsResultCallback}
     * and the results of permission requests will be delivered to its {@link
     * android.support.v4ox.app.ActivityCompat.OnRequestPermissionsResultCallback#onRequestPermissionsResult(
