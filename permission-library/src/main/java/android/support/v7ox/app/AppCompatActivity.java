...
import android.support.v4ox.app.TaskStackBuilder;
import android.support.v4ox.view.KeyEventCompat;
import android.support.v7ox.view.ActionMode;
import android.support.v7ox.widget.TintResources;
 ...
 *
 * <p>You can add an {@link android.support.v7ox.app.ActionBar} to your activity when running on API level 7 or higher
 * by extending this class for your activity and setting the activity theme to
 * {@link android.support.v7ox.appcompat.R.style#Theme_AppCompat Theme.AppCompat} or a similar theme.
 *
...
public class AppCompatActivity extends FragmentActivity implements AppCompatCallback,
     ...
     * {@link android.support.v7ox.app.ActionBar} for this Activity window.
     *
     * <p>When set to a non-null value the {@link #getActionBar()} method will return
     * an {@link android.support.v7ox.app.ActionBar} object that can be used to control the given
