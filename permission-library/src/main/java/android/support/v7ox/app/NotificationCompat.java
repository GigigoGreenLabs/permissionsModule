 ...
 * {@link android.support.v7ox.app.NotificationCompat.MediaStyle}. You should start using this variant
 * if you need support for media styled notifications.
 */
public class NotificationCompat extends android.support.v4ox.app.NotificationCompat {

    private static void addMediaStyleToBuilderLollipop(
            NotificationBuilderWithBuilderAccessor builder, android.support.v4ox.app.NotificationCompat.Style style) {
        if (style instanceof MediaStyle) {
            MediaStyle mediaStyle = (MediaStyle) style;
            NotificationCompatImpl21.addMediaStyle(builder,
                    mediaStyle.mActionsToShowInCompact,  null);
        }
    }

    private static void addMediaStyleToBuilderIcs(NotificationBuilderWithBuilderAccessor builder,
            android.support.v4ox.app.NotificationCompat.Builder b) {
     ...
     */
    public static class Builder extends android.support.v4ox.app.NotificationCompat.Builder {
    ...
    private static class IceCreamSandwichExtender extends BuilderExtender {
        ...
        @Override
        public Notification build(android.support.v4ox.app.NotificationCompat.Builder b,
     ...
     * {@link android.support.v7ox.app.NotificationCompat.MediaStyle#setMediaSession}, the System UI
     ...
     */
    public static class MediaStyle extends android.support.v4ox.app.NotificationCompat.Style {
        ...
        public MediaStyle(android.support.v4ox.app.NotificationCompat.Builder builder) {
            setBuilder(builder);
        }
