...
abstract class AppCompatDelegateImplBase extends AppCompatDelegate {
  ...
  @Override public MenuInflater getMenuInflater() {
    ...
    if (mMenuInflater == null) {
      initWindowDecorActionBar();
      mMenuInflater =
          new SupportMenuInflater(mActionBar != null ? mActionBar.getThemedContext() : mContext);
    }
  ...
  @Override public void setLocalNightMode(@NightMode int mode) {
    // no-op
  }

  @Override public final ActionBarDrawerToggle.Delegate getDrawerToggleDelegate() {
  ...
  private class ActionBarDrawableToggleImpl implements ActionBarDrawerToggle.Delegate {
    @Override public Drawable getThemeUpIndicator() {
      final TintTypedArray a =
          TintTypedArray.obtainStyledAttributes(getActionBarThemedContext(), null,
              new int[] { R.attr.homeAsUpIndicator_ox });
    ...
    @Override public void setActionBarUpIndicator(Drawable upDrawable, int contentDescRes) {
      ActionBar ab = getSupportActionBar();
      if (ab != null) {
  ...
  @Override public void setHandleNativeActionModesEnabled(boolean enabled) {
    // no-op pre-v14
  }

  @Override public boolean isHandleNativeActionModesEnabled() {
    // Always false pre-v14
    return false;
  }

  @Override public boolean applyDayNight() {
    // no-op on v7
    return false;
  }
  ...
  class AppCompatWindowCallbackBase extends WindowCallbackWrapper {
    ...
    @Override public boolean dispatchKeyEvent(KeyEvent event) {
      return AppCompatDelegateImplBase.this.dispatchKeyEvent(event) || super.dispatchKeyEvent(
          event);
    }

    @Override public boolean dispatchKeyShortcutEvent(KeyEvent event) {
      return super.dispatchKeyShortcutEvent(event) || AppCompatDelegateImplBase.this.onKeyShortcut(
