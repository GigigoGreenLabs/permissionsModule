...
package android.support.v4ox.view.accessibility;

import android.graphics.Rect;
import android.os.Build;
import android.os.Bundle;
import android.support.v4ox.accessibilityservice.AccessibilityServiceInfoCompat;
...
public class AccessibilityNodeInfoCompat {
    ...
    interface AccessibilityNodeInfoImpl {
        ...
        Object obtainCollectionItemInfo(int rowIndex, int rowSpan, int columnIndex, int columnSpan,
