...
package com.gigigo.ggglib.permission.ui;
...
import com.gigigo.ggglib.permission.RationaleResponse;
...
public class PermissionsUIViews {
  ...
  public static void showDefaultRationaleView(final PermissionToken token, Context context) {
    ...
    new AlertDialog.Builder(context).setTitle(R.string.continueRequestPermissionRationaleTitle)
