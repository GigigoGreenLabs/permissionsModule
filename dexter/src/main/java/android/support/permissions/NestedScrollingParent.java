...
import android.support.permissions.NestedScrollingParentHelper;
import android.support.permissions.ViewCompat;
import android.support.permissions.ViewGroupCompat;
import android.support.permissions.ViewParentCompat;
 ...
 * {@link android.support.v4ox.view.ViewCompat}, {@link ViewGroupCompat} or {@link ViewParentCompat} compatibility
...
public interface NestedScrollingParent {
     ...
     * {@link android.support.v4ox.view.ViewCompat#startNestedScroll(View, int)}. Each parent up the view hierarchy will be
     ...
     * @param nestedScrollAxes Flags consisting of {@link android.support.v4ox.view.ViewCompat#SCROLL_AXIS_HORIZONTAL},
     *                         {@link android.support.v4ox.view.ViewCompat#SCROLL_AXIS_VERTICAL} or both
     ...
     * <p/>
     * <p>A NestedScrollingParent returning something other than {@link android.support.v4ox.view.ViewCompat#SCROLL_AXIS_NONE}
     * is currently acting as a nested scrolling parent for one or more descendant views in
     * the hierarchy.</p>
     *
     * @return Flags indicating the current axes of nested scrolling
     * @see android.support.v4ox.view.ViewCompat#SCROLL_AXIS_HORIZONTAL
     * @see android.support.v4ox.view.ViewCompat#SCROLL_AXIS_VERTICAL
