...
import android.support.permissions.*;
import android.support.permissions.Fragment;
import android.support.permissions.FragmentManager;
import android.support.permissions.FragmentManagerImpl;
import android.support.permissions.FragmentTransaction;
import android.support.permissions.FragmentTransitionCompat21;
import android.support.permissions.SharedElementCallback;
import android.support.permissions.ArrayMap;
...
final class BackStackRecord extends FragmentTransaction implements
     ...
     * in {@link #setNameOverrides(android.support.v4ox.app.BackStackRecord.TransitionState, ArrayList,
     * ArrayList)}.
     */
