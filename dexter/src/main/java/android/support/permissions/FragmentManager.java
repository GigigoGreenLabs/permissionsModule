...
import android.support.annotationox.CallSuper;
import android.support.annotationox.IdRes;
import android.support.annotationox.StringRes;
import android.support.permissions.BackStackRecord;
import android.support.permissions.BackStackState;
import android.support.permissions.FragmentActivity;
import android.support.permissions.FragmentContainer;
import android.support.permissions.FragmentTransaction;
import android.support.permissions.NoSaveStateFrameLayout;
import android.support.permissions.SuperNotCalledException;
import android.support.permissions.DebugUtils;
import android.support.permissions.LogWriter;
import android.support.permissions.LayoutInflaterFactory;
import android.support.permissions.ViewCompat;
 ...
 *
 * <p>Your activity must derive from {@link android.support.v4ox.app.FragmentActivity} to use this. From such an activity,
 * you can acquire the {@link FragmentManager} by calling
 * {@link android.support.v4ox.app.FragmentActivity#getSupportFragmentManager}.
 */
public abstract class FragmentManager {
     ...
     * after {@link android.support.v4ox.app.FragmentActivity#onSaveInstanceState FragmentActivity.onSaveInstanceState()}
     * (and prior to a following {@link android.support.v4ox.app.FragmentActivity#onStart FragmentActivity.onStart}
