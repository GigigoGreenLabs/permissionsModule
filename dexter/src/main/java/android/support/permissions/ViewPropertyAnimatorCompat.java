...
import android.support.permissions.ViewPropertyAnimatorUpdateListener;
...
public final class ViewPropertyAnimatorCompat {
     ...
     * {@link android.support.v4ox.view.ViewCompat#setLayerType(View, int, android.graphics.Paint) layer type} set to
     * {@link android.support.v4ox.view.ViewCompat#LAYER_TYPE_HARDWARE} for the duration of the next animation.
     * As stated in the documentation for {@link android.support.v4ox.view.ViewCompat#LAYER_TYPE_HARDWARE},
     ...
     * effectively be the same as {@link android.support.v4ox.view.ViewCompat#LAYER_TYPE_SOFTWARE}.
     *
