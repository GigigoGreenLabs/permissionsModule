...
import android.support.v4ox.util.SimpleArrayMap;
import android.support.v7ox.view.menu.MenuWrapperFactory;
...
public class SupportActionModeWrapper extends ActionMode {
    ...
    final android.support.v7ox.view.ActionMode mWrappedObject;

    public SupportActionModeWrapper(Context context,
            android.support.v7ox.view.ActionMode supportActionMode) {
        mContext = context;
     ...
     * @hide
     */
    public static class CallbackWrapper implements android.support.v7ox.view.ActionMode.Callback {
        ...
        @Override
        public boolean onCreateActionMode(android.support.v7ox.view.ActionMode mode, Menu menu) {
            return mWrappedCallback.onCreateActionMode(getActionModeWrapper(mode),
                    getMenuWrapper(menu));
        }

        @Override
        public boolean onPrepareActionMode(android.support.v7ox.view.ActionMode mode, Menu menu) {
            return mWrappedCallback.onPrepareActionMode(getActionModeWrapper(mode),
                    getMenuWrapper(menu));
        }

        @Override
        public boolean onActionItemClicked(android.support.v7ox.view.ActionMode mode,
        ...
        @Override
        public void onDestroyActionMode(android.support.v7ox.view.ActionMode mode) {
        ...
        public ActionMode getActionModeWrapper(android.support.v7ox.view.ActionMode mode) {
